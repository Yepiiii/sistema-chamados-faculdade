...
namespace SistemaChamados.Migrations
{
    ...
    [Migration("20251023133441_MigracaoContextoEmpresarial")]
    partial class MigracaoContextoEmpresarial
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SistemaChamados.Core.Entities.Chamado", b =>
                {
                    ...
                    b.Property<int?>("TecnicoTIPerfilId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SistemaChamados.Core.Entities.Chamado", b =>
                {
                    ...
                    b.HasOne("SistemaChamados.Core.Entities.TecnicoTIPerfil", null)
                        .WithMany("ChamadosAtribuidos")
                        .HasForeignKey("TecnicoTIPerfilId");
